...
<div class="gallery-note notebook-transcript-note">
  <strong>Executed tutorial notebook.</strong> This page is generated from <a href="https://github.com/systems-mechanobiology/De-Time/blob/main/examples/notebooks/quant_trading/04_turtle_donchian_breakout_volume_confirmation.ipynb"><code>examples/notebooks/quant_trading/04_turtle_donchian_breakout_volume_confirmation.ipynb</code></a> and includes markdown cells, code cells, stdout, tables, and captured figures from the committed notebook.
</div>
